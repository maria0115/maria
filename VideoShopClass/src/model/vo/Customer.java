...
public class Customer {
	...
	String tfCustTelSearch;



public String getTfCustTelSearch() {
		return tfCustTelSearch;
	}

	public void setTfCustTelSearch(String tfCustTelSearch) {
		this.tfCustTelSearch = tfCustTelSearch;
	}
