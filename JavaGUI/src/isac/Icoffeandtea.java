...
public class Icoffeandtea extends JPanel{
	...
	//	
	JLabel special = new JLabel(new ImageIcon("src/y_isacimage1/커피.png")); 
	JLabel white = new JLabel(new ImageIcon("src/y_isacimage1/티앤라떼.png"));
	...
	public void setlayout()
	{
		...
		bs1 = new JButton(new ImageIcon("src/y_isacimage1/에스프레소.png"));
		bw1 = new JButton(new ImageIcon("src/y_isacimage1/아메리카노.png"));
		bw2 = new JButton(new ImageIcon("src/y_isacimage1/밀크티.png"));
		bw3 = new JButton(new ImageIcon("src/y_isacimage1/아이스티.png"));
