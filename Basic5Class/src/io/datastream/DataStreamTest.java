...
class UIForm extends JFrame
{
	...
	class BtnHandler implements ActionListener 
	{
		public void actionPerformed( ActionEvent ev ){
			...
			if( evtBtn == bSave )
			{
				...
				*/
				...
				try{
					...
					DataOutputStream dos = new DataOutputStream(new FileOutputStream("data.txt"));	//필터
			...
			*/
				try{
					DataInputStream dos = new DataInputStream(new FileInputStream("data.txt"));	//필터
					
					System.out.println(dos.readUTF(dos));
